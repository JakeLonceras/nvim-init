return {
  ...
  dependencies = {
    ...
    require('lua.user.reiend.plugins.cmp-nvim-lsp').name,
    require('lua.user.reiend.plugins.cmp-buffer').name,
    require('lua.user.reiend.plugins.cmp-path').name,
    require('lua.user.reiend.plugins.cmp-cmdline').name,
    require('lua.user.reiend.plugins.lua-snip').name,
    require('lua.user.reiend.plugins.cmp-lua-snip').name,
  },
  version = '*',
  lazy = false,
  config = function()
